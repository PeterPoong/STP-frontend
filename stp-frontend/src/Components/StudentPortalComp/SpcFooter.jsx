      ...
      >
        <div style={{ marginBottom: "5px", marginTop : "5px"}}>
          <Row>
            ...
            <button type="button" className="btn btn-outline-danger rounded-circle p-0 social-btn instagram-btn" style={{width: '40px', height: '40px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button" className="btn btn-outline-danger rounded-circle p-0 social-btn email-btn" style={{width: '40px', height: '40px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
