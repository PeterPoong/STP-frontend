...
const typeDescriptions = {
  Realistic: {
    unique:
      "Your natural ability to understand how things work and your hands-on approach makes you the go-to person for turning ideas into reality.",
    strength:
      "Your practical mindset and hands-on capabilities allow you to tackle real-world challenges with confidence and precision.",
  },
  Investigative: {
    unique:
      "Your dedication to finding answers and understanding complex systems makes you an excellent researcher and problem solver.",
    strength:
      "Your curious and analytical mind drives you to understand how and why things work. You excel at solving complex problems and uncovering new insights.",
  },
  Artistic: {
    unique:
      " Your creative vision and ability to think outside the box allows you to see possibilities where others see limitations.",
    strength:
      "Your imaginative mind and creative instincts enable you to see the world differently and create unique solutions that others might never consider.",
  },
  Social: {
    unique:
      "Your genuine interest in people and natural ability to understand others makes you an inspiring force for positive change.",
    strength:
      "Your natural empathy and people-focused mindset help you build meaningful connections and make a positive impact in others' lives.",
  },
  Enterprising: {
    unique:
      "Your natural leadership and ability to inspire others makes you the perfect person to turn visions into successful ventures.",
    strength:
      "Your dynamic personality and leadership instincts make you naturally effective at motivating teams and driving initiatives to success.",
  },
  Conventional: {
    unique:
      "Your exceptional attention to detail and organizational skills make you the master of creating order from chaos.",
    strength:
      "Your systematic approach and precise attention to detail make you exceptional at creating and maintaining efficient, well-organized systems.",
  },
};
...
const CareerProfile = ({}) => {
  ...
  useEffect(() => {
    const storedUsername =
      sessionStorage.getItem("riasecUserName") ||
      localStorage.getItem("riasecUserName") ||
    ...
    const fetchResults = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_BASE_URL}api/student/getTestResult`,
          {
            method: "GET",
            headers: {
      ...
      <div className="RS-Header-Section">
        <div>
          ...
          <p style={{ fontSize: "14px", marginBottom: "10px" }}>
            Most recent test: {new Date(createdAt).toISOString().split("T")[0]}
          </p>
        </div>
        <button className="SSP-Start-Button" onClick={handleRetakeTest}>
          Retake RIASEC Test
        </button>
      ...
      <div className="RS-Recommended-Course-Container">
          ...
          <div className="RS-Courses-Grid">
            {recommendedCategories.map((course, index) => (
              ...
              >
                ...
                {/* Use course.category_name instead of course */}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="RS-Section-Card">
          <h3 className="RS-Section-Title">
            Featured Courses for Your Study Paths
          </h3>
                      ...
                      <div className="ms-1 d-flex row justify-content-between">
                        <div>
                          <p style={{ color: "#BA1718" }}>
                            {username}, Your TOP 1 RIASEC test result are
                          </p>
