  ...
  return (
    ...
    <Card className="mb-4">
      ...
      <Card.Body>
        ...
        <h2 className=" lead fw-normal mb-3 " style={{color:"black"}}>Basic Information</h2>
        </div>
        <Form>
          <Row>
            <Col md={6}>
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group controlId="identityCardNumber">
                <Form.Label className="fw-bold small">Identity Card Number <span className="text-danger">    *</span></Form.Label>
                <Form.Control type="text" required className="w-75" />
              </Form.Group>
            </Col>
            <Col md={6}>
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group controlId="country">
                <Form.Label className="fw-bold small">Country <span className="text-danger">    *</span></Form.Label>
                <Form.Select required className="w-75">
            ...
            <Col md={6}>
              <Form.Group controlId="state">
                <Form.Label className="fw-bold small">State <span className="text-danger">    *</span></Form.Label>
                <Form.Select required className="w-75">
          ...
          <Row className="mb-4">
            <Col md={6}>
              <Form.Group controlId="city">
                <Form.Label className="fw-bold small">City <span className="text-danger">    *</span></Form.Label>
                <Form.Select required className="w-75">
            ...
            <Col md={6}>
              <Form.Group controlId="postcode">
                <Form.Label className="fw-bold small">Postcode <span className="text-danger">    *</span></Form.Label>
                <Form.Control type="text" required className="w-75"/>
              </Form.Group>
            </Col>
          </Row>
